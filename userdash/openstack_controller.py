...
def create_instance(**kwargs):
    try:
        ...
        key_name = 'abcd'
        private_key_filename = "/home/hemant/private_keys/" + key_name + ".pem"
        private_key = None
        ...
        return {'private_key': private_key, 'file_name': private_key_filename, 'status': 'Success'}
    except Exception as e:
    ...
    try:
        ...
        for instance in instances:
            ...
            if current_instance.status != 'TERMINATED':
                ...
                instance_info['floating_ip'] = current_instance.networks['cf-net'][1]
                instance_info['instance_id'] = instance.instance_id
                instance_details.append(instance_info)

        return {'instance_details': instance_details, 'status': 'Success'}
...
def list_images():
    try:
        creds = get_keystone_creds()
        keystone = ksclient.Client(2, **creds)
